...
- custom ticket create pages: static definition/submit API plus saved Lua and OpenRouter AI schema/default transformation implemented; project management UI with inline edits, preview run history, and browser rendering/submission implemented;
