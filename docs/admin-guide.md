...
- list roles;
- inspect individual role details;
- create and delete global role bindings;
- list project members and create/list project role bindings;
