...
- [User Guide](user-guide.md): current browser workflows, API-only workflows, and planned board/backlog/sprint workflows.
- [Admin Guide](admin-guide.md): bootstrap credentials, user/group administration, RBAC, settings, and planned admin surfaces.
- [API Guide](api.md): JSON conventions, errors, auth requirements, implemented endpoints, search, saved views, comments, and attachments.
...
- [Automation and Lua](automation-lua.md): current status plus planned Lua, JSON/table conversion, cron, hooks, webhooks, notifications, and OpenRouter AI design.
