...
- [API Guide](api.md): JSON conventions, errors, auth requirements, implemented endpoints, search, saved views, comments, attachments, and cron jobs.
