...
- [Automation and Lua](automation-lua.md): current status plus Lua JSON/table conversion, cron jobs, ticket-hook runner behavior, webhooks, and planned notification/OpenRouter AI/WebAssembly design.
