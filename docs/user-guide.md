...
- custom ticket create-page list, create, inline edit, enable/disable, delete, schema preview, preview run-history, and intake-form links for the selected project;
