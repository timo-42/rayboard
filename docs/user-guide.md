...
- custom field list/create/update/delete with metadata summaries and a layout overview with type breakdowns plus requirement/configuration insight counts for the selected project, plus field-aware custom-field controls on ticket create and ticket cards;
