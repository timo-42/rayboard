...
- component and version list/create/edit/delete, version release/archive state changes, ticket component/version assignment, project ticket filtering by component/version, and richer release reports with live-versus-released snapshot scope labels, release health summaries, release timeline summaries, scope-change summaries, status breakdowns, component breakdowns, point totals, and unassigned-component highlighting;
