...
- workflow status replacement, board create/select/edit/delete, board-backed ticket columns, backlog drag/drop reorder, and board card drag/drop status changes for the selected project;
