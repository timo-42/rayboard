...
- project ticket-hook management on `/automation`, including list, create, inline edit, delete, enable/disable, and preview through `/api/projects/{project_id}/ticket-hooks`, `/api/ticket-hooks/{hook_id}`, and `/api/ticket-hooks/{hook_id}/preview`.
