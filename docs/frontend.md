...
- rendered custom ticket create-page intake forms under `/projects/{project_id}/create/{slug}`, using the resolved structured schema, safe section/help/group layout widgets with nested fields, preview run-history inspection, and submissions through `/api/projects/{project_id}/ticket-create-pages/{slug}/submit`.
