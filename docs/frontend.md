...
- compact sprint reports with live current-assignment and completed snapshot scope markers, sprint health summaries from sprint dates/state, story-point velocity when estimates exist, ticket-count fallback analytics, remaining count, burnup summary, scope-change summaries, priority breakdowns, issue-type breakdowns, label breakdowns, estimate coverage, component breakdowns, version breakdowns, assignee workload summaries, and ticket links for the selected project.
