...
- a backlog panel with planning summary metrics, estimate coverage, priority breakdowns, sprint workload summaries, current sprint labels, sprint assignment/removal controls, up/down controls, and native drag/drop ticket reordering through `/api/projects/{project_id}/backlog`;
