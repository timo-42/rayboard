...
- a roadmap panel with a scheduled epic timeline, aggregate capacity insights, read-only monthly capacity summary buckets, selected-month capacity drilldowns, drag/drop timeline rescheduling, quick scheduling for unscheduled epics, inline schedule edits, child-ticket progress, dependency overview summaries, read-only dependency graph visualization, and dependency list/editing controls, plus ticket-form fields for epics, parent epics, and roadmap dates;
