...
- custom ticket create-page management on `/automation`, including list, create, enable/disable, delete, schema preview, preview run-history inspection, and intake-form links through `/api/projects/{project_id}/ticket-create-pages` and `/api/ticket-create-pages/{page_id}/runs`;
