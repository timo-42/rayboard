...
Drag/drop UI, board settings UI, board UI beyond the current simple status shell, richer backlog planning, sprint report screens, release reports, roadmap timeline UI, component/version UI screens, custom-field screens, and advanced release planning are **Planned**.
