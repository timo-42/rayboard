...
func TestOpenAPIJSON(t *testing.T) {
	...
	assertRequestBodyFields(t, spec, "/api/projects/{project_id}/roadmap/schedule", http.MethodPatch, []string{"spec"}, []string{"spec", "items"}, []string{"spec", "items", "ticket_id"}, []string{"spec", "items", "start_date"}, []string{"spec", "items", "due_date"})
