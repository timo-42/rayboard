...
func openAPIConfig() huma.Config {
	...
	config.OpenAPI.Components.SecuritySchemes = map[string]*huma.SecurityScheme{
		"bearerToken": {
			...
			Description:  "API token generated by an authenticated user. Browser sessions are accepted at runtime via the rayboard_session cookie, and Swagger UI sends browser cookies plus the CSRF header automatically when present.",
		},
	}
