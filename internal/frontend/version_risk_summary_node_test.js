...
const { versionReportRiskSummary } = require("./static/app.js");

assert.deepStrictEqual(versionReportRiskSummary([
...
assert.deepStrictEqual(versionReportRiskSummary([], "2026-06-20"), []);
assert.deepStrictEqual(versionReportRiskSummary(null, "2026-06-20"), []);
assert.deepStrictEqual(versionReportRiskSummary({}, "2026-06-20"), []);
