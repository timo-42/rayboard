...
const { sprintReportStartDateBreakdown } = require("./static/app.js");

assert.deepStrictEqual(sprintReportStartDateBreakdown([
...
assert.deepStrictEqual(sprintReportStartDateBreakdown([], "2026-06-20"), []);
assert.deepStrictEqual(sprintReportStartDateBreakdown(null, "2026-06-20"), []);
