...
const { versionReportAttentionSummary } = require("./static/app.js");

assert.deepStrictEqual(versionReportAttentionSummary([
...
assert.deepStrictEqual(versionReportAttentionSummary([], "2026-06-20"), []);
assert.deepStrictEqual(versionReportAttentionSummary(null, "2026-06-20"), []);
assert.deepStrictEqual(versionReportAttentionSummary({}, "2026-06-20"), []);
