...
const { sprintReportReporterBreakdown } = require("./static/app.js");

assert.deepStrictEqual(sprintReportReporterBreakdown([
...
assert.deepStrictEqual(sprintReportReporterBreakdown([]), []);
assert.deepStrictEqual(sprintReportReporterBreakdown(null), []);
