...
const { versionReportReadinessSummary } = require("./static/app.js");

assert.deepStrictEqual(versionReportReadinessSummary([
...
assert.deepStrictEqual(versionReportReadinessSummary([]), []);
assert.deepStrictEqual(versionReportReadinessSummary(null), []);
assert.deepStrictEqual(versionReportReadinessSummary({}), []);
