...
const { sprintReportAgeBreakdown } = require("./static/app.js");

assert.deepStrictEqual(sprintReportAgeBreakdown([
...
assert.deepStrictEqual(sprintReportAgeBreakdown([], "2026-06-20"), []);
assert.deepStrictEqual(sprintReportAgeBreakdown(null, "2026-06-20"), []);
